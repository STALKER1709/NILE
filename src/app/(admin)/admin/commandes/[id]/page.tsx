  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5">
      <div className="flex items-center justify-between">
        ...
        <Link href="/admin/commandes" className="text-sm text-gray-500 hover:underline">← Commandes</Link>
      </div>
      ...
      <Carte className="p-4">
        ...
        <div className="mt-2 flex justify-between border-t border-gray-100 pt-2 font-bold"><span>Total</span><Prix montant={commande.total} className="text-nile" /></div>
      </Carte>
      ...
      <Carte className="space-y-3 p-4">
        ...
        <div className="border-t border-gray-100 pt-3">
          ...
          {commande.livraison?.preuveUrl && (
            <Vignette url={commande.livraison.preuveUrl} alt="Preuve" sizes="112px" className="mt-2 h-28 w-28 rounded-lg border border-gray-100" />
          )}
