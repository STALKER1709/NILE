...
export function CarteProduitVitrine({
  ...
  return (
    <article
      ...
      className="flex animate-fondu-haut flex-col rounded-xl border border-contour-carte bg-white p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-carte-hover"
    >
