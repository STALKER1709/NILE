  ...
  return (
    <aside className="lg:w-60 lg:shrink-0">
      ...
      <div className="mb-5 hidden items-center gap-3 lg:flex">
        <span className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-nile-800 to-nile-600 text-lg font-black text-amber-400">
        ...
        {LIENS.map((l) => {
          ...
          return (
            <Link
              ...
              className={`flex shrink-0 items-center gap-2.5 rounded-lg px-3.5 py-2.5 text-sm font-semibold transition-colors ${
                actif
              ...
              {l.href === "/vendeur/commandes" && aPreparer > 0 && (
                <span
                  className={`ml-auto grid h-5 min-w-[1.25rem] shrink-0 place-items-center rounded-full px-1 text-[11px] font-bold ${
                    actif ? "bg-white text-nile-800" : "bg-amber-500 text-white"
                  }`}
                >
                  {aPreparer}
                </span>
      ...
      <div className="mt-4 space-y-2 border-t border-slate-200/80 pt-4">
        <Link
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-nile-900 px-4 py-2.5 text-sm font-bold text-white transition-colors hover:bg-nile-800"
        >
        ...
        <Link
          href="/aide"
          className="flex items-center gap-2.5 rounded-lg px-3.5 py-2 text-sm text-slate-500 transition-colors hover:bg-slate-100 hover:text-nile-800"
        >
